...
<f:view>
    <html>
        <head>
            <meta charset="utf-8">
            <title>Trang Cập nhật thông tin sản phẩm</title>
        ...
        <body style="background-color: #D2D6DE">
            ...
            <div class="container" style="background-color: whitesmoke">
                <div class="col-md-12">
                    ...
                    <div class="col-md-2">
                        <a href="<%= request.getContextPath() %>/trangchu.html"><i class="fa fa-home"></i>Trang chủ</a>
                    </div>
                ...
                <div>    
                    ...
                    <div class="col-md-12" style="border: solid">
                        ...
                        <form:form method="post" commandName="sp" action="${sp.maSanPham}.html">
                            <div class="col-md-1 ">
